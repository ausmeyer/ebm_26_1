...
<p class="source-line">Population: pediatric residents; mixed outpatient, inpatient, research, and quality-improvement settings. Question 9 uses an adult dataset to teach a population-agnostic statistical concept.</p>
...
<form id="quiz-form-1">
  <div class="incidence-options" aria-hidden="true">
  <span></span><span class="opt-head">Incidence</span><span class="opt-head">Prevalence</span>
  </div>
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 10. User-provided 99-page learner-mode export dated 2025-08-28.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 10. User-provided export.
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 24. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 20. User-provided export. The visible stem is condensed; counts and timing are unchanged.
:::
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 20. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 22. User-provided export. The stem is condensed for slide legibility.
:::
...
<div class="flow-row">
  ...
  <div class="flow-node"><strong>Random allocation</strong><br>supplement or comparator</div>
  <div class="flow-arrow">→</div>
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 22. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 23. User-provided export. The stem is condensed for slide legibility.
:::
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 23. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 25. User-provided export. The stem is condensed for slide legibility.
:::
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 25. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 18. User-provided export. This vignette is used only to teach causal reasoning and is not presented as evidence that cellular telephone towers cause autism.
:::
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 18. User-provided export.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 15. User-provided export. All ages and counts are retained; framing is shortened for slide legibility.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 15. User-provided export. Its exact data yield the displayed means and medians.
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 15. User-provided export. Plotted values exactly reproduce the source stem; no patient data.
:::
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 16. User-provided export. The source population is adult; the statistical calculation is population-agnostic, but the clinical association should not be generalized to children without pediatric evidence.
:::
...
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 16. User-provided export.
:::
...
<br><br>
Of the following, the MOST appropriate method of determining whether this procedure resulted in the desired reduced wait times is to display the data on a
</p>
...
:::{.notes}
[Sources]
- American Academy of Pediatrics. Basic PREP Statistics Assessment, Question 44. User-provided export.
:::
