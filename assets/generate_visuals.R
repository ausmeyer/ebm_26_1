...
rect(3.55, 0.65, 6.45, 5.1, col = "#E8F1F7", border = secondary, lwd = 4)
...
arrows(3.35, 3.25, 2.7, 3.25, length = 0.1, col = muted, lwd = 2)
text(2.5, 3.25, "Direction\nunknown", col = muted, cex = 1.1, pos = 2)
arrows(6.65, 3.25, 7.3, 3.25, length = 0.1, col = warning, lwd = 2)
text(7.5, 3.25, "Temporality\nnot established", col = warning, cex = 1.1, pos = 4)
...
text(1.7, 88, sprintf("Baseline median = %.1f", baseline_median),
